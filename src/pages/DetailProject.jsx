    ...
    return (
        <div>
            ...
            <div className="banner">
                ...
                <div className="container mx-auto mt-52 px-5">
                    <div className="flex flex-col gap-2 justify-center items-center">
                        ...
                        <motion.p className="text-5xl font-bold text-slate-700" transition={{duration: 1, delay: 0.5, type: "spring", stiffness: 100}} whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} viewport={{once: false, amount: 0.5}}>Detail Project</motion.p>
                        <motion.p className="text-xl text-slate-700" transition={{duration: 1, delay: 0.5, type: "spring", stiffness: 100}} whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} viewport={{once: false, amount: 0.5}}>{project.title}</motion.p>
            ...
            <div className="container mx-auto">
                <div className="flex flex-col md:flex-row gap-16 items-center md:justify-center">
                    <div className="overflow-hidden rounded-2xl max-w-[600px] max-h-[400px]">
                    ...
                    <div className="text-center px-5 md:px-0 md:text-start md:w-1/2">
                        <p className="font-semibold text-3xl text-[#45474B]">{project.title}</p>
                        {/* <p className="text-xs text-[#A149FA]">React.js, Laravel, Node.js</p> */}
                        <motion.div className="pt-1 bg-[#A149FA] max-w-[100px] mt-2 mx-auto md:mx-0" transition={{duration: 1, delay: 0.5, type: "spring", stiffness: 100}} whileInView={{ opacity: 1, scale: 1 }} initial={{ opacity: 0, scale: 0 }} viewport={{once: false, amount: 0.5}}></motion.div>
                        ...
                        <p className="text-slate-500 my-4">{project.description}</p>
            ...
            <div className="container mx-auto mt-32">
                <div className="text-center">
                    <p className="font-bold text-3xl text-[#45474B]">More Project's Done</p>
                ...
                <div className="gap-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-12 mx-5 xl:mx-0">
                    {currentProjects && currentProjects.length > 0 ? (
                        ...
                        <motion.div key={item.id} variants={cardVariants} transition={{duration: 1, delay: index * 0.3, type: "spring", stiffness: 100}} whileInView={"visible"} initial="hidden" viewport={{once: false, amount: 0.5}}>
